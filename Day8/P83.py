...
#                                                                                       #
QUIZ, EXAM, ASSIGNMENT, PROJECT = FIRST, SECOND, THIRD, FOURTH  # ordering of marks     #
# ------------------------------------------------------------------------------------- #
#############################[ IMMUTABLE CODE SECTION END ]##############################


class StudentGradingSystem(object):
    """Student Grading System Class.
    Attributes:
        database (& related schema) - in memory student database maintainted as a pandas dataframe
        max_marks, weightage        - scoring/ grading criteria for students
        records_file_name           - name of the file used for storing database on disk
    """
